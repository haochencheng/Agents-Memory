...
from agents_memory.constants import BRIDGE_TEMPLATE_NAME, COPILOT_INSTRUCTIONS_REL, DEFAULT_BRIDGE_INSTRUCTION_REL, MCP_CONFIG_NAME, PYTHON_BIN, REGISTER_HINT, VSCODE_DIRNAME
